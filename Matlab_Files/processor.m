...
%    clear;clc;
    ...
    %% 选择数据所在的文件夹
    % 设置数据存放的文件夹路径
    Path = '/home/xuemeng/Proj/ChestMotion/Matlab_Files/data/';
    ...
    data_dir = '/home/xuemeng/Proj/ChestMotion/Matlab_Files/data/' + name + '/WAV'; % data dir
    ...
    result_root_dir =  '/home/xuemeng/Proj/ChestMotion/Matlab_Files/processed/'; % result dir
    epoch_nums = 15; % 循环的次数
