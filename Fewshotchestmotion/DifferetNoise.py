...
import DifferentNoise_Test
import DifferentNoise_Train
import BuiltNN_Keras


# Load Data Set.
# 1. In two method multi-person & single person.
data_cup_train, cupLabels_train = DifferentNoise_Train.LoadData()
data_cup_test, cupLabels_test = DifferentNoise_Test.LoadData()
# 1. Rename Data
...
# Compile Model.
# sgd = optimizers.SGD(lr=0.0004, decay=1e-7, momentum=0.9, nesterov=True)
...
# Training Model.
VoiceChestModel.fit(x_train, y_train, epochs=40, batch_size=100)
