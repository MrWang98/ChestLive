...
import DifferentDevice_Test
import DifferentDevice_Train
import BuiltNN_Keras


# Load Data Set.
# 1. In two method multi-person & single person.
data_cup_train, cupLabels_train = DifferentDevice_Test.LoadData()
data_cup_test, cupLabels_test = DifferentDevice_Train.LoadData()
# 1. Rename Data
