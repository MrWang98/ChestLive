...
import DifferentArouseWord_Train
import DifferentArouseWord_Test
import BuiltNN_Keras


# Load Data Set.
# 1. In two method multi-person & single person.
data_cup_train, cupLabels_train = DifferentArouseWord_Train.LoadData()
data_cup_test, cupLabels_test = DifferentArouseWord_Test.LoadData()
# 1. Rename Data
