...
def LoadData():
    ...
    for i in Range3:
        ...
        if 'cor4_ccc2' in data_tmp:
            together_data = np.concatenate(
                (data_tmp['cor1_ccc2'], data_tmp['cor2_ccc2'], data_tmp['cor3_ccc2'], data_tmp['cor4_ccc2']), axis=0)
        else:
            together_data = np.concatenate((data_tmp['cor1_ccc2'], data_tmp['cor2_ccc2'], data_tmp['cor3_ccc2']),
                                           axis=0)
        if i == 1:
