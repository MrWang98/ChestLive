...
import DifferentDistance_Train
import DifferentDistance_Test
import BuiltNN_Keras
import BuiltNN_Keras_bak

# Load Data Set.
# 1. In two method multi-person & single person.
data_cup_train, cupLabels_train = DifferentDistance_Train.LoadData()
data_cup_test, cupLabels_test = DifferentDistance_Test.LoadData()
# 1. Rename Data
