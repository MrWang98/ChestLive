...
import DifferentDirection_Test
import DifferentDirection_Train
import BuiltNN_Keras

# Load Data Set.
# 1. In two method multi-person & single person.
data_cup_train, cupLabels_train = DifferentDirection_Train.LoadData()
data_cup_test, cupLabels_test = DifferentDirection_Test.LoadData()
# 1. Rename Data
