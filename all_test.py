...
for i in range(number):
  ...
  for images, labels in test_set:
      ...
      person[keys[0]].append([labels[0],preds[0]])
      person[keys[1]].append([labels[1],preds[1]])
      print("labels:{}, preds:{}".format(labels,preds))
      flags = (labels==preds)
...
with open("r_{}.txt".format(person_number),"w") as f:
    f.write(str(result))
with open("result_{}.txt".format(person_number),"w") as f:
    f.write(str(person))
